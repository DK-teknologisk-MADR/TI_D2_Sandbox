...
evaluator = kpt_Eval(p1_model_dir,mask_net_chk_fp=os.path.join(discriminator_dir,'best_model.pth'),base_dir=base_dir,split=split,plot_dir=plot_dir,device='cuda:1',mask_encoding='poly',img_size=(530,910),p2_prepper = prepper,p2_object_area_thresh=0.09,skip_phase2=False,p3_kpts_nr=21,kpts_to_plot=[6,14])
