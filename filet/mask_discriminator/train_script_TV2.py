...
base_prep = PreProcessor_Crop_n_Resize_Box(resize_dims=(393,618),pad=35,mean=[0.2010, 0.1944, 0.2488, 0.0000],std=[0.224, 0.224, 0.224, 1])  #not used
dt = Filet_Seg_Dataset_Box(mask_dir=data_dir, img_dir=img_dir,split=train_split,preprocessor=base_prep , trs_y=[Rectifier(.94,.94)])
dt_val = Filet_Seg_Dataset_Box(mask_dir=data_dir, img_dir=img_dir,split=val_split,preprocessor=base_prep , trs_y=[Rectifier(.94,.94)])
...
quants =np.array([0.84]) #quants = np.quantile(iou_arr,qs)
#ious.std()
#np.hstack([quants])
