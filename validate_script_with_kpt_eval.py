...
evaluator = kpt_Eval(p1_model_dir,base_dir=base_dir,split=split,plot_dir=plot_dir,device='cuda:1',mask_encoding='bit_mask',img_size=(530,910),p2_prepper = None,p2_object_area_thresh=0.09)
