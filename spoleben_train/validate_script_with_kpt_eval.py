...
evaluator = kpt_Eval(p1_model_dir,mask_net_chk_fp=None,base_dir=base_dir,split=split,plot_dir=plot_dir,device='cuda:1',mask_encoding='bit_mask',img_size=(450,450),p2_prepper = None,skip_phase2=True,p3_kpts_nr=9,kpts_to_plot=[4],supervised = False,p1_aug_vote_th=4)
