...
tester = ModelTester_Aug(os.path.join(p1_model_dir, 'cfg.yaml'), os.path.join(p1_model_dir, 'best_model.pth'), os.path.join(p2_model_dir, "best_model.pth"), p3_kpts_nr=kpts_out, p2_crop_size=fixed_parameters["p2_crop_size"], p2_resize_shape = fixed_parameters["p2_resize_shape"], device='cuda:1')
